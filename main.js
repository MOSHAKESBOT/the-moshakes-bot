...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ مرحبا بك معاك/ي بوت اسمي ساسكي* \n*║*\n*╟❧ وصف المجموعه:*\n\n@desc\n\n*║*\n*╟❧ واتمنى ان تستمتع معنا بالمجموعه*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ غادر المجموعه ⛔*\n*╚══════════════*'
conn.spromote = '*@user اصبح مشرف !!*'
conn.sdemote = '*@user تم تنزيله من مشرف الى عضو تبأ لك كنت ادمن فاشل🥲!!*'
